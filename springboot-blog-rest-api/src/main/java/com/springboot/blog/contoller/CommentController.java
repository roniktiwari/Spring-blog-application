...
public class CommentController {
       ...
       public ResponseEntity<String> updatePostById(@PathVariable(name="postId") long postId , @PathVariable(name="commentId") long commentId , @RequestBody CommentDto commentDto)
       {
